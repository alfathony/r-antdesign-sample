...
class form extends Component {
  ...
  render() {
    ...
    return (
      ...
      >
	    	<Row className="app-login-container d-flex justify-content-center align-items-center animated slideInUpTiny animation-duration-3">
		      <Col className="app-login-main-content">
		      	...
		      	<div className="app-login-content">
		      		<div className="app-login-header mb-4"><h1><span>Email</span></h1></div>
...
export const PageLogin = Form.create()(form);
